  ...
  return (
    <section className={`w-full h-full  ${selectedConversation === null ? "hidden" : ""} lg:flex lg:flex-col lg:w-[50vw]`}>
      {selectedConversation === null ? (
        ...
        <div className="w-screen bg-[#151419]   backdrop-blur-3xl  h-full absolute top-0 left-0 z-50 flex flex-col lg:backdrop-blur-none  lg:relative lg:bg-transparent lg:z-0  lg:w-[50vw]">
          <User />
