        ...
        <form >
          ...
          <div className="flex w-full mt-8 flex-col justify-center items-center gap-3">
            <label className="input input-bordered flex items-center gap-2">
              ...
              <input type="text" className="w-60 " placeholder="Email" />
            </label>
            <label className="input input-bordered flex items-center gap-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <input type="text" className="w-60" placeholder="Full Name" />
            </label>
            <label className="input input-bordered flex items-center gap-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <input type="text" className="w-60" placeholder="Username" />
            </label>
            <label className="input input-bordered flex items-center gap-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <input type="password" className="w-60" placeholder="Password" />
            </label>
            <label className="input input-bordered flex items-center gap-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
